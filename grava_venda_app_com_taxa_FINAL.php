        ...
        while ($row_convenio = $sql_pede_senha->fetch()) {
            ...
            if ($evetivar == true) {
                ...
                try {
                    ...
                    // VERIFICAÇÃO ROBUSTA: Considera TODAS as possíveis descrições de taxa
                    // Verifica por: convenio 249 + divisao + mes (independente da descrição)
                    ...
                    if ($taxa_ja_lancada) {
                        ...
                        foreach ($taxas_existentes as $idx => $taxa_existente) {
                            error_log("   Taxa #" . ($idx + 1) . ": ID=" . $taxa_existente['lancamento'] . 
                                     ...
                                     ", Descrição='" . $taxa_existente['descricao'] . "'" .
                    ...
                    // (SOMENTE SE NÃO EXISTIR NENHUMA TAXA NO MÊS)
                    // ============================================
                    if (!$taxa_ja_lancada) {
                        ...
                        error_log("ℹ️ Taxa de cartão NÃO foi gravada - já existe no mês (independente da descrição)");
